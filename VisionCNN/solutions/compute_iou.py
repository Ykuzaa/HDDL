def compute_iou(y_pred_coord, y_true_coord):
    ...
    pred_box_xy = y_pred_coord[:, 0:2] * y_std_t[1:3] + y_mean_t[1:3]
    true_box_xy = y_true_coord[:, 0:2] * y_std_t[1:3] + y_mean_t[1:3]

    ### "Denormalization" of the width and height of bounding boxes
    pred_box_wh = y_pred_coord[:, 2:4] * y_std_t[3:5] + y_mean_t[3:5]
    true_box_wh = y_true_coord[:, 2:4] * y_std_t[3:5] + y_mean_t[3:5]
