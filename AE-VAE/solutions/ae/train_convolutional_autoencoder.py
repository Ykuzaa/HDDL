def train_convolutional_autoencoder(autoencoder,
    ...
    This is the only difference, and it is the point of the exercise: a convolutional
    network takes its input as [B, 1, 28, 28] and gives it back in the same layout.
    """
